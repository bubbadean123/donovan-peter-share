...
# (n,e) = public key
# (n,d) = private key
print "Number of bits to use: "
bits = gets.to_i
if bits < 128
  puts "Not recommended to use less than 128 bits for generating keys as it can cause some data loss."
  # raise "Bits not large enough"
end
...
puts "Encrypted msg  : #{c}"
puts ""
puts "Decrypt again  : #{RSA.decrypt( c, n, d )}"

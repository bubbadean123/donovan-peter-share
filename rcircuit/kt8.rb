...
class KT8Decoder < Device
  def initialize(init_args={})
    ...
    dec=Decoder.new(4).sel(@ins4to7).en(1).o0(aen).o1(ben).o2(wr).o3(rbsel).o8(ren).o11(den)
    dec1=Decoder.new(4).sel(@ins0to3).en(den)
  end
...
class KT8 < Device
 def initialize(init_args={})
  ...
  define_port("daddr",5)
  define_port("din",8)
  dec = KT8Decoder.new().ins(ins)
  @dec=dec
  wr.connect(dec.wr)
  pc = Counter.new(8).clk(cclk).rst(rst).load(0).out(paddr)
...
dbg=Dbg.new("paddr"=>kt8.paddr,"daddr"=>kt8.daddr,"aval"=>kt8.a.out,"rval"=>kt8.r.out,"ins"=>kt8.ins,"aen"=>kt8.gdec.aen,"ben"=>kt8.gdec.ben,"ren"=>kt8.gdec.ren,"wr"=>kt8.gdec.wr,"rbsel"=>kt8.gdec.rbsel,"aluop"=>prog_mem.out.slice(0..3))
prog_mem[0]="00000000"
prog_mem[1]="10000111"
prog_mem[2]="01000001"
data_mem[0]="1011"
